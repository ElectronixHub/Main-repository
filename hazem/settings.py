...
SECRET_KEY = 'django-insecure-rpq@+e3)a=8jt6#-(0#2va0aym#qtt*z&sxz=pwn2@h8#l81el'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Use '*' for development only; specify hostnames for production.
...
INSTALLED_APPS = [
    ...
    'mydjangoproject',  # Your app name here
]
